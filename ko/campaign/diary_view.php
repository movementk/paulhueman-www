...
<body class="sub campaign">
	...
	<main id="content" class="diary-view">
		<div class="container">
			<!-- page-path -->
			<div class="page-path">
				<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-xs-12 col-lg-2">
						<div class="lnb">
							...
							<ul>
								<li><a href="<?php echo _langBase; ?>/campaign/celeb_list.php">CELEB</a></li>
								...
								<li class="active"><a href="<?php echo _langBase; ?>/campaign/diary_list.php">DIARY</a></li>
							</ul>
						</div>
					</div>
					<?php
